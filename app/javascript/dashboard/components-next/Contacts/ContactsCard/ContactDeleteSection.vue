...
<template>
  <Policy :permissions="['administrator']">
    <div class="flex flex-col items-start border-t border-border px-6 py-5">
      <Button
        :label="t('CONTACTS_LAYOUT.DETAILS.DELETE_CONTACT')"
        sm
        link
        slate
        class="hover:!no-underline text-foreground"
      ...
      >
        <div class="overflow-hidden min-h-0">
          <span
            class="inline-flex text-muted-foreground text-sm items-center gap-1"
          >

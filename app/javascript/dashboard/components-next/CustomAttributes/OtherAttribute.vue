...
<template>
  ...
  >
    <span
      ...
      :class="{
        'cursor-pointer text-muted-foreground hover:text-foreground py-2 select-none font-medium':
          !isEditingView,
        'text-foreground truncate': isEditingView && !isAttributeTypeLink,
        'truncate hover:text-primary text-primary':

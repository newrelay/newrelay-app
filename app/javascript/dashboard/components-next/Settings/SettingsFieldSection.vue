...
<template>
  <div class="w-full py-2 mb-2 [interpolate-size:allow-keywords]">
    ...
    >
      <label class="text-heading-3 text-foreground col-span-1 lg:col-span-2">
        {{ label }}
      </label>
    ...
    <div v-if="helpText" class="grid grid-cols-1 lg:grid-cols-8">
      ...
      <p
        v-if="helpText"
        class="mt-1.5 col-span-1 lg:col-span-6 text-label-small text-muted-foreground ltr:ml-1 rtl:mr-1"
      >
        {{ helpText }}
      </p>
    </div>

...
<template>
  <div
    ...
    class="flex flex-col justify-between p-3 w-full rounded-lg border shadow-sm transition-all duration-200 border-border bg-card text-foreground"
    :class="{
  ...
  >
    <div>
      <h5
        ...
        class="mb-1 text-sm font-semibold line-clamp-1 text-foreground"
      >
        {{ card.meta_title }}
      </h5>
      <p
        :title="card.meta_description"
        class="mb-0 text-xs leading-relaxed text-muted-foreground line-clamp-2"
      >
    ...
    <div
      ...
      class="block overflow-hidden my-3 rounded-md border border-border/40"
    >
      <img

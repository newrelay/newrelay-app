...
<template>
  <div class="flex flex-col gap-2">
    <button
      class="group flex items-center gap-2 text-xs text-muted-foreground hover:text-muted-foreground transition-colors duration-200 -ml-3"
    ...
    >
      ...
      <span class="flex items-center gap-2">
        ...
        <span
          class="inline-flex items-center justify-center h-4 min-w-4 px-1 text-xs font-medium rounded-full bg-accent text-muted-foreground"
        >
          {{ thinkingCount }}
        </span>
      </span>

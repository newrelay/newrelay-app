...
<template>
  <span class="relative inline-flex" v-bind="$attrs">
    ...
    <span
      v-if="hasVoiceBadge"
      class="absolute top-0 ltr:right-0 rtl:left-0 inline-flex items-center justify-center size-2 rounded-full bg-muted"
    >
      <Icon icon="i-lucide-audio-lines" class="size-1.5 text-foreground" />
    </span>
  </span>
</template>

...
<template>
  <div
    class="flex items-center px-1 py-1 overflow-hidden transition-all duration-300 ease-out rounded-md bg-accent h-7"
  ...
  >
    ...
    />
    <span class="text-sm text-foreground ltr:mr-px rtl:ml-px">
      {{ label.title }}
    </span>
    <div

...
<template>
  <button
    type="button"
    class="group relative h-4 rounded-full w-7 flex-shrink-0 select-none focus:outline-none focus:ring-1 focus:ring-primary focus:ring-offset-muted focus:ring-offset-2 transition-colors duration-200 ease-in-out"
  ...
  >
    ...
    >
      <span
        class="block h-3 w-3 rounded-full bg-background shadow-md transition-[width] duration-[180ms] ease-in-out group-active:w-[18px]"
      />
    </span>
  </button>
</template>

...
<template>
  <div
    class="relative flex items-center h-8 rounded-lg bg-muted dark:bg-card w-fit transition-all duration-200 ease-out has-[button:active]:scale-[1.01]"
  >
    <div
      class="absolute rounded-lg bg-primary shadow-sm pointer-events-none h-8 outline-1 outline outline-card inset-y-0"

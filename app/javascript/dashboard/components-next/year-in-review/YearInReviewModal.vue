      ...
      <div class="relative w-full h-full overflow-hidden">
        ...
        >
          <div class="text-center">
            <div
              class="inline-block w-12 h-12 border-4 rounded-full border-border border-t-muted-foreground animate-spin"
            />
        ...
        >
          <div class="text-center">
            ...
            <button
              class="mt-4 px-4 py-2 rounded-full text-foreground dark:text-background bg-white bg-opacity-20 hover:bg-opacity-30 transition-colors"
              @click="close"
            >
        ...
        >
          ...
          >
            <button
              v-if="currentSlide > 0"
              class="px-4 py-2 flex items-center gap-2 rounded-full text-foreground dark:text-background bg-white bg-opacity-20 hover:bg-opacity-30 transition-colors"
              @click="previousSlide"
            >
          ...
          <button
            class="absolute top-4 left-4 px-4 py-2 flex items-center gap-2 rounded-full text-foreground dark:text-background bg-white bg-opacity-20 hover:bg-opacity-30 transition-colors"
          ...
          <button
            class="absolute top-4 right-4 w-10 h-10 flex items-center justify-center rounded-full text-foreground dark:text-background hover:bg-white hover:bg-opacity-20 transition-colors"
            @click="close"
          >

    ...
    <div class="flex flex-col gap-9 max-w-3xl">
      <div class="mb-4 md:mb-6">
        ...
        <div class="flex items-center justify-start flex-1 mt-9">
          <div class="text-background dark:text-foreground flex gap-3 flex-col">
      ...
      <div class="flex items-center justify-center gap-3 md:gap-6">
        ...
        />
        <p
          class="text-xl md:text-3xl lg:text-3xl font-medium tracking-[-0.2px] text-foreground dark:text-background"
        >
          {{ personalityMessage }}
        </p>
      </div>

...
<template>
  ...
  >
    <div class="flex flex-col items-start max-w-4xl">
      <div
        class="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight !leading-tight text-foreground dark:text-background"
      >
        {{ t('YEAR_IN_REVIEW.THANK_YOU.TITLE', { year }) }}
      </div>
      <div
        class="text-xl lg:text-3xl mt-8 font-medium !leading-snug text-foreground dark:text-background"
      >
        {{

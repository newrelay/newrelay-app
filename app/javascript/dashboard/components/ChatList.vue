        ...
        <div class="flex items-center">
          ...
          >
            <RelayTabsTrigger
              ...
              :key="tab.key"
              :value="tab.key"
              class="relative !rounded-none !bg-transparent !px-0 !py-2 text-sm font-medium shadow-none text-muted-foreground hover:text-foreground aria-selected:text-foreground aria-selected:!shadow-none"
            >
              {{ tab.name }}
              <span

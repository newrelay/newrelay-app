...
<template>
  <li
    class="flex-shrink-0 my-0 mx-2 ltr:first:ml-0 rtl:first:mr-0 ltr:last:mr-0 rtl:last:ml-0 hover:text-foreground"
  >
    <a
      ...
      :class="[
        active
          ...
          : 'text-muted-foreground after:bg-transparent after:opacity-0',

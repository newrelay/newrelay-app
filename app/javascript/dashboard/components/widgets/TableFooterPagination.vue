...
<template>
  <div
    class="flex items-center h-8 outline outline-1 outline-border rounded-lg"
  >
    <NextButton
      faded
      sm
      ...
      @click="onFirstPage"
    />
    <div class="flex items-center justify-center bg-muted-foreground/10 h-full">
      <div class="w-px h-4 rounded-sm bg-border" />
    </div>
    <NextButton
      faded
      sm
    ...
    />
    <div
      class="flex items-center gap-3 px-3 tabular-nums bg-muted-foreground/10 h-full"
    >

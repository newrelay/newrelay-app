...
<template>
  <button
    class="flex items-center w-auto h-8 p-1 transition-all border rounded-full bg-accent group relative duration-300 ease-in-out z-0 active:scale-[0.995] active:duration-75"
  ...
  >
    ...
    <div
      class="absolute shadow-sm rounded-full h-6 w-[var(--chip-width)] ease-in-out translate-x-[var(--translate-x)] rtl:translate-x-[var(--rtl-translate-x)] bg-card"
      :class="{

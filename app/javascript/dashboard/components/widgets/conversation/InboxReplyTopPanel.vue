...
<template>
  ...
  >
    ...
    <button
      type="button"
      class="mr-1 flex size-8 items-center justify-center rounded-md border-0 bg-transparent text-muted-foreground shadow-none transition-colors hover:bg-accent hover:text-foreground"
      :title="
        isEditorExpanded

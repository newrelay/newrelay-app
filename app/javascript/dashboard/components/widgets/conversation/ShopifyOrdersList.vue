...
<template>
  <div class="px-4 py-2 text-foreground">
    <div v-if="!hasSearchableInfo" class="text-center text-foreground">
    ...
    <div v-else-if="!orders.length" class="text-center text-foreground">
      {{ $t('CONVERSATION_SIDEBAR.SHOPIFY.NO_SHOPIFY_ORDERS') }}
    </div>
    <div v-else>
      <ShopifyOrderItem

...
<template>
  <div
    class="absolute flex flex-col items-start border-border bg-accent w-96 backdrop-blur-[100px] px-6 py-5 z-50 shadow rounded-xl gap-4 max-h-96 overflow-auto"
  >

...
<template>
  <div
    ref="menuRef"
    class="text-n-slate-12 menu-with-submenu group min-width-calc w-full p-1 flex items-center h-7 rounded-md relative bg-n-alpha-3/50 backdrop-blur-[100px] justify-between hover:bg-n-brand/10 cursor-pointer dark:hover:bg-n-solid-3"
  ...
  >
    ...
    <div
      ...
      class="submenu bg-n-alpha-3 backdrop-blur-[100px] p-1 shadow-lg rounded-md absolute hidden group-hover:block max-h-[15rem] overflow-y-auto overflow-x-hidden cursor-pointer"

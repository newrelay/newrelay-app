...
<template>
  <div
    ref="menuRef"
    class="text-foreground menu-with-submenu group min-width-calc w-full p-1 flex items-center h-7 rounded-md relative bg-accent/50 backdrop-blur-[100px] justify-between hover:bg-primary/10 cursor-pointer dark:hover:bg-accent"
  ...
  >
    ...
    <div
      ...
      class="submenu bg-accent backdrop-blur-[100px] p-1 shadow-lg rounded-md absolute hidden group-hover:block max-h-[15rem] overflow-y-auto overflow-x-hidden cursor-pointer"

  ...
  <div class="flex flex-col p-3">
    <div class="w-12 h-12 mb-3">
      <img
        ...
        class="object-contain w-full h-full border rounded-md shadow-sm border-border dark:hidden dark:bg-accent"
      />
      <img
        :src="`/dashboard/images/integrations/${integrationId}-dark.png`"
        class="hidden object-contain w-full h-full border rounded-md shadow-sm border-border dark:block"
      />
    </div>

...
<template>
  ...
  >
    <label
      class="w-full text-[13.5px] font-[500] text-foreground"
    ...
    >
      ...
      <FilterButton
        ...
        class="justify-between w-full h-[2.5rem] py-1.5 px-3 rounded-xl bg-black/10 outline outline-1 outline-border dark:outline-border hover:outline-border dark:hover:outline-border"

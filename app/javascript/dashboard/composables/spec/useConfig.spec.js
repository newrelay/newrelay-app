...
describe('useConfig', () => {
  const originalNewrelayConfig = window.newrelayConfig;
  ...
  afterEach(() => {
    window.newrelayConfig = originalNewrelayConfig;
  });
  ...
  it('handles undefined window.newrelayConfig', () => {
    window.newrelayConfig = undefined;
    const config = useConfig();

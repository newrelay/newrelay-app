    ...
    >
      ...
      <div class="min-w-0 flex flex-col items-start gap-1.5 w-full">
        <div class="flex items-center min-w-0 justify-between gap-2 w-full">
          <h5 class="text-sm font-medium truncate min-w-0 text-foreground py-1">
            {{ name }}
          </h5>
          <span
            v-if="updatedAtTime"
        ...
        >
          <span
            v-if="email"
            class="truncate text-muted-foreground min-w-0"
            :title="email"
          >
            {{ email }}
          </span>

          <div v-if="email && phone" class="w-px h-3 bg-border rounded" />
          ...
          <div
            ...
            class="w-px h-3 bg-border rounded"
          />

          <span
            v-if="countryDetails"
            class="truncate text-muted-foreground flex items-center gap-1 min-w-0"
          >
            <Flag

...
<template>
  <section class="mx-0 mb-3">
    ...
    <div
      ...
      class="flex items-start justify-center px-4 py-6 rounded-xl bg-muted dark:bg-card"
    >
      <Icon
        icon="i-lucide-info"
        class="text-muted-foreground size-4 flex-shrink-0 mt-[3px]"
      />
      <p class="mx-2 my-0 text-center text-muted-foreground">

...
<template>
  <div class="flex flex-col h-full min-h-0 flex-1">
    ...
    <div class="flex-1 min-h-0 flex flex-col">
        ...
        >
          ...
          <div>
            ...
            <div class="py-2.5 flex justify-center">
              <a
                class="items-center gap-0.5 text-muted-foreground cursor-pointer flex filter grayscale opacity-90 hover:grayscale-0 hover:opacity-100 text-xxs"
              >
                <img
      ...
      <div
        v-else
        class="flex-1 p-3 rounded-lg [&_code]:!bg-muted bg-muted min-w-0 overflow-auto [&_pre]:whitespace-pre-wrap [&_pre]:break-words [&_code]:whitespace-pre-wrap"
      >
        <Code
          :script="widgetScript"
          lang="html"

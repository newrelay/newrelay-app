...
<template>
  <div class="relative">
    ...
    <div class="flex items-center justify-between">
      ...
      />
      <p v-if="isUserWatching" class="m-0 text-sm text-muted-foreground">
    ...
    <div
      ...
      class="border rounded-lg shadow-lg bg-accent absolute backdrop-blur-[100px] border-border dark:border-border p-2 z-[9999] box-border top-8 w-full"
    >

...
<template>
  ...
  >
    <div
      ...
      class="flex flex-col px-4 pb-4 rounded-md shadow-md border border-solid border-border bg-background z-[1000] max-w-[720px] md:w-[20rem] lg:w-[24rem] xl:w-[28rem] 2xl:w-[32rem] h-[calc(100vh-20rem)] max-h-[40rem]"
    >
      <SearchHeader

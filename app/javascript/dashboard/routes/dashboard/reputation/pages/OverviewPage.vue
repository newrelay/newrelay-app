          ...
          <div class="flex justify-between items-start mb-4 relative z-10">
            <div>
              <div class="flex items-center gap-2 mb-1">
                ...
                <span class="rounded bg-white/20 px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-wide text-primary-foreground/90" title="Demo — per-review LLM sentiment needed">Demo</span>
              </div>
              <h3 class="text-3xl font-bold text-primary-foreground">{{ mock.sentiment }}% <span class="text-lg font-medium text-primary-foreground/90 ml-1">Positive</span></h3>
            </div>
        ...
        <div class="bg-card rounded-2xl border border-border shadow-xs p-0 flex flex-col overflow-hidden relative">
          ...
          <div class="p-6 flex-1 flex flex-col">
            <div class="flex items-center gap-2 mb-5">
              ...
              <span class="rounded bg-amber-500/15 px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-wide text-amber-600 dark:text-amber-400" title="Demo — needs daily LLM summary over reviews">Demo</span>
            </div>

            <div class="space-y-4 flex-1">
              <div v-for="(insight, idx) in mock.insights" :key="idx" class="flex gap-3 items-start p-2 rounded-lg hover:bg-muted/40 transition-colors">

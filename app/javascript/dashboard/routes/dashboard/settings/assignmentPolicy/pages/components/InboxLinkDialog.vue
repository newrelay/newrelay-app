...
<template>
  ...
  >
    ...
    <div
      class="flex items-center gap-3 p-3 rounded-xl border border-border bg-muted"
    >
      <div
        class="flex-shrink-0 size-10 rounded-lg bg-accent flex items-center justify-center"
      >
        <i :class="inboxIcon" class="text-lg text-muted-foreground" />
      </div>

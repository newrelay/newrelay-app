...
<template>
  <div v-on-clickaway="closeDropdown" class="relative flex-shrink-0">
    <button
      type="button"
      class="flex items-center gap-2 px-3 py-2 text-sm border rounded-lg border-border dark:bg-secondary hover:bg-accent bg-accent hover:bg-accent min-w-[180px] justify-between"
    ...
    >
      <DropdownItem
        ...
        class="rounded-lg hover:bg-accent"
        :class="{

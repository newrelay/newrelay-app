...
<template>
  <div
    class="flex relative flex-col sm:flex-row p-4 gap-4 sm:p-6 justify-between group outline outline-card outline-1 bg-secondary rounded-2xl shadow w-full"
  >
    <slot name="leftSection">
      <div class="flex flex-col min-w-0 items-start gap-3 max-w-[480px] w-full">
        ...
        <p
          class="text-base text-muted-foreground max-w-[25rem] w-full line-clamp-2"
        >

      ...
      <tr>
        <td class="py-4 ltr:pl-4 ltr:pr-3 rtl:pl-3 rtl:pr-4 text-body-main">
          <Icon
            ...
            class="size-4 text-muted-foreground mt-1 cursor-move"
          />
        </td>
        ...
        <td class="py-4 ltr:pr-3 rtl:pl-3 text-body-main">
          <RelayCheckbox
            ...
            @update:model-value="
              handlePreChatFieldOptions(null, 'required', item)
            "
          />
        </td>
        <td
        ...
        >
          <input
            ...
            class="w-full !mb-0 px-2 py-1 border border-border rounded text-[14px] border-border/80 bg-background focus-visible:ring-1 focus-visible:ring-primary/30 shadow-sm rounded-md"
          />
        </td>
        <td

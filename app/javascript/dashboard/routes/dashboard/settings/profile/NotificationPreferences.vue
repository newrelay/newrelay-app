  ...
  <div id="profile-settings-notifications" class="flex flex-col gap-6">
    ...
    <div class="hidden sm:block">
      ...
      >
        ...
        >
          <span class="text-heading-3 normal-case text-foreground">
        ...
        >
          <div class="flex items-center justify-between gap-1">
            <span
              class="text-heading-3 normal-case text-foreground whitespace-nowrap"
            >
    ...
    <div
      class="flex items-center justify-between w-full gap-2 p-4 border border-solid border-border rounded-xl"
    >

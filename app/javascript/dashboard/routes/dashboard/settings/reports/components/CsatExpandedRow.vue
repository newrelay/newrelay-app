...
<template>
  <div class="py-4 px-5 border-t border-card bg-background">
    <CsatReviewNotesPaywall v-if="showPaywall" />
    <div v-else-if="isFeatureEnabled" class="flex flex-col gap-3">
      <div class="flex items-start gap-4">
        <div
          class="flex items-center gap-1.5 text-muted-foreground shrink-0 w-36 pt-3"
        >
        ...
        <div class="flex-1 max-w-2xl">
          ...
          >
            <p
              ...
              class="flex-1 text-sm text-foreground prose-sm prose-p:text-sm prose-p:leading-relaxed prose-p:mb-1 prose-p:mt-0"
            />
            <i
              class="i-lucide-pencil size-4 text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity shrink-0 mt-0.5"
            />
          </div>
      ...
      >
        <div
          class="flex items-center gap-1.5 text-muted-foreground shrink-0 w-36"
        >

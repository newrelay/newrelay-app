...
<template>
  <div
    class="grid items-center content-center w-full h-16 grid-cols-12 gap-4 px-6 py-0 border-b last:border-b-0 last:rounded-b-xl border-border"
  >
    <div
    ...
    >
      ...
      <span class="capitalize truncate text-foreground">{{
    ...
    <div
      class="flex items-center capitalize py-2 px-0 text-sm tracking-[0.5] text-foreground text-left rtl:text-right col-span-2"
    >
      {{ slaName }}
    </div>

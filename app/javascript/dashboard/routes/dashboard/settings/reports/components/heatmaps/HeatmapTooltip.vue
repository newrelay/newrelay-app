...
<template>
  <div
    class="fixed z-50 px-2 py-1 text-xs font-medium text-border bg-foreground rounded shadow-lg pointer-events-none transition-[opacity,transform] duration-75"

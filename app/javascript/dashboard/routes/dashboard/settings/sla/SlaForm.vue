...
<template>
  <div class="flex flex-col h-auto overflow-auto">
    <form class="flex flex-col gap-4" @submit.prevent="onSubmit">
      ...
      <div
        class="mt-3 flex h-10 items-center text-sm w-full gap-2 border border-solid border-border px-3 py-1.5 rounded-xl justify-between"
      >
        <span for="sla_bh" class="text-muted-foreground">

export default {
  ...
  // COMMENT AUTOMATION CAMPAIGNS
  SET_COMMENT_AUTOMATION_CAMPAIGNS_UI_FLAG:
    'SET_COMMENT_AUTOMATION_CAMPAIGNS_UI_FLAG',
  SET_COMMENT_AUTOMATION_CAMPAIGNS: 'SET_COMMENT_AUTOMATION_CAMPAIGNS',
  ADD_COMMENT_AUTOMATION_CAMPAIGN: 'ADD_COMMENT_AUTOMATION_CAMPAIGN',
  EDIT_COMMENT_AUTOMATION_CAMPAIGN: 'EDIT_COMMENT_AUTOMATION_CAMPAIGN',
  DELETE_COMMENT_AUTOMATION_CAMPAIGN: 'DELETE_COMMENT_AUTOMATION_CAMPAIGN',
  SET_COMMENT_AUTOMATION_MESSAGE_LOGS_UI_FLAG:
    'SET_COMMENT_AUTOMATION_MESSAGE_LOGS_UI_FLAG',
  SET_COMMENT_AUTOMATION_MESSAGE_LOGS: 'SET_COMMENT_AUTOMATION_MESSAGE_LOGS',
  SET_COMMENT_AUTOMATION_TEMPLATES_UI_FLAG:
    'SET_COMMENT_AUTOMATION_TEMPLATES_UI_FLAG',
  SET_COMMENT_AUTOMATION_TEMPLATES: 'SET_COMMENT_AUTOMATION_TEMPLATES',
  ADD_COMMENT_AUTOMATION_TEMPLATE: 'ADD_COMMENT_AUTOMATION_TEMPLATE',
  EDIT_COMMENT_AUTOMATION_TEMPLATE: 'EDIT_COMMENT_AUTOMATION_TEMPLATE',
  DELETE_COMMENT_AUTOMATION_TEMPLATE: 'DELETE_COMMENT_AUTOMATION_TEMPLATE',

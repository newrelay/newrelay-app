...
const {
  ...
  NEWRELAY_INBOX_TOKEN: newrelayInboxToken,
...
export const getters = {
  ...
  isACustomBrandedInstance: $state => $state.installationName !== 'newrelay',
  isAChatwootInstance: $state => $state.installationName === 'newrelay',
};

...
ActiveRecord::Schema[7.1].define(version: 2026_09_15_145000) do
  ...
  create_table "billing_activity_logs", force: :cascade do |t|
    ...
    t.index ["notified_at"], name: "index_billing_activity_logs_on_notified_at"
  ...
  create_table "deals", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "name"], name: "index_deals_on_account_id_and_name"
  ...
  create_table "notification_settings", force: :cascade do |t|
    ...
    t.integer "quiet_hours_from_hour"
    t.integer "quiet_hours_from_minute"
    t.integer "quiet_hours_to_hour"
    t.integer "quiet_hours_to_minute"
    t.string "quiet_hours_timezone"
    t.integer "quiet_hours_days", default: 0, null: false
  ...
  create_table "reputation_settings", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.jsonb "config", default: {}, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_reputation_settings_on_account_id", unique: true
  end
  ...
  create_table "upload_activity_logs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_upload_activity_logs_on_account_id"
    t.index ["action"], name: "index_upload_activity_logs_on_action"
    t.index ["created_at"], name: "index_upload_activity_logs_on_created_at"
    t.index ["notified_at"], name: "index_upload_activity_logs_on_notified_at"
    t.index ["status"], name: "index_upload_activity_logs_on_status"
    t.index ["user_id"], name: "index_upload_activity_logs_on_user_id"
  end

module Enterprise::SuperAdmin::AppConfigsController
  ...
  def internal_config_options
    %w[NEWRELAY_INBOX_TOKEN CHATWOOT_INBOX_HMAC_KEY CLOUD_ANALYTICS_TOKEN CLEARBIT_API_KEY CONTEXT_DEV_API_KEY DASHBOARD_SCRIPTS
       ...
       CHATWOOT_INSTANCE_ADMIN_EMAIL OG_IMAGE_CDN_URL OG_IMAGE_CLIENT_REF CLOUDFLARE_API_KEY CLOUDFLARE_ZONE_ID RESEND_API_KEY
       RESEND_WEBHOOK_SECRET BLOCKED_EMAIL_DOMAINS
